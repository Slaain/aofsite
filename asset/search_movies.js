...
{
	//creation d'une variable pour selectionner l'element sur lequel je veux agir
	var search_query = document.getElementsByName('search_box')[0].value;

	if(search_query == '')
	{
//recuperation de la requete
		fetch("../controller/process_data.php", {
...
// requete ajax pour la recherche de loeuvre
function load_data(query)
{
	if(query.length > 2)
	{
		...
		ajax_request.open('POST','../controller/process_data.php');
