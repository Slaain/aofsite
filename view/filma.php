...
<link rel="stylesheet" href="../asset/filmstyle.css">
...
<section>
<h1>Notre selection de films d'animation du jour</h1>
<!-- Caroussel avec 4 img -->
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
<div class="carousel-inner">
<div class="carousel-item active">
<a href="../page/yourname.php"><img src="../images/yourname.jpg" class="d-block w-100" alt="..."></a>
</div>

<div class="carousel-item">
<a href="../page/ambulant.php"><img src="../images/ambulant.jpg" class="d-block w-100" alt="..."></a>
</div>

<div class="carousel-item">
<a href="../page/pancreas.php"><img src="../images/pancreas.jpg" class="d-block w-100" alt="..."></a>
</div>

<div class="carousel-item">
<a href="../page/red.php"><img src="../images/red.jpg" class="d-block w-100" alt="..."></a>
</div>
</div>
...
<h2 class="text-center mt-4 mb-4">Rechercher votre film d'animation</h2>
...
<script src="../asset/search_movies.js"></script>
